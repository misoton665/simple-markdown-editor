...
markdownShowingView model =
  div [style ["flex" => "1", "background" => "#ffffff", "height" => "100%", "padding" => "16px", "resize" => "none", "width" => "50%"]] [
    h1 [] [text "VIEWER"]
  , Markdown.toHtml [style ["width" => "100%", "resize" => "none", "overflow" => "scroll", "padding" => "4px", "height" => "80%", "border" => "1px solid #aaa"]] model.markdownText
  ]